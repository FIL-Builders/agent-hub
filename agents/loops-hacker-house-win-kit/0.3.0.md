...
* name: randamu/randomness-js
  ...
  * Randomness.verify
    ...
    * Keep the wallet funded for tx fees; the SDK sends a transaction to RandomnessSender.
      ...
      since: "^0.1.0"
      source: randamu-dcipher-sdk/0.3.0.md
...
* label: Randamu dCipher SDK Agent Spec
  url: [https://raw.githubusercontent.com/FIL-Builders/agent-hub/refs/heads/main/agents/randamu-dcipher-sdk/0.3.0.md](https://raw.githubusercontent.com/FIL-Builders/agent-hub/refs/heads/main/agents/randamu-dcipher-sdk/0.3.0.md)
