...
4. After setup, verify the connection by listing the available tools and fetching the latest "react" pack.
...
- The connection is verified by listing tools and fetching the latest react pack.`;
...
function compactPrompt() {
  return [
    ...
    'Use it to list packs, check versions, and fetch the right spec at runtime.',
    '',
    'Server: https://agent-hub-1.netlify.app/mcp',
    '',
    'Set it up if you can. Otherwise give me exact manual',
    'steps and verify the connection by fetching react.',
  ].join('\n');
}
